...
namespace WindowsFormsApplication2
{
  public class Form1 : Form
  {
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      {
        int num1 = (int) MessageBox.Show("Please enter a valid Date");
      }
      if (this.textBox3.Text == "")
      {
        int num2 = (int) MessageBox.Show("Select Database File");
      }
      else
      {
        try
        {
          ...
          {
            int num3 = (int) MessageBox.Show("Please Check Start and End Dates");
          }
        }
        catch (Exception ex)
        {
          int num3 = (int) MessageBox.Show("Invalid Entry");
        }
      }
    }
    ...
    internal void GenerateXML(DateTime StartDate, DateTime EndDate)
    {
      try
      {
        ...
        OleDbConnection oleDbConnection = new OleDbConnection("Provider=Microsoft.JET.OLEDB.4.0;data source='" + this.fpath + "';Jet OLEDB:Database Password=''");
    ...
    private void button2_Click(object sender, EventArgs e)
    {
      ...
      this.openFileDialog1.Filter = "Microsoft Office Access Database|*.mdb";
